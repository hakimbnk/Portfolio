document.addEventListener('DOMContentLoaded', () => {
    ...
    const interactables = document.querySelectorAll('a, button, .project-card, .gallery-item, .contact-form input, .contact-form textarea');
    ...
    const observer = new IntersectionObserver((entries) => {
        entries.forEach(entry => {
            if (entry.isIntersecting) {
                ...
                if(entry.target.id === 'about' || entry.target.classList.contains('about-text')) {
    ...
    if(contactForm) {
        contactForm.addEventListener('submit', (e) => {
            ...
            btnSubmit.innerHTML = 'Envoi... <i class="fa-solid fa-spinner fa-spin"></i>';
